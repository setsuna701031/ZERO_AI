...
def run(argv=None):
 p=argparse.ArgumentParser(prog="zero-capability-authorization-token-issuance-preparation");p.add_argument("--eligibility",required=True);p.add_argument("--prepared-at");p.add_argument("--output")
 ...
 r=prepare_capability_authorization_token_issuance(v,prepared_at=a.prepared_at)
 ...
 return r,0
def main(argv=None):
 r,c=run(argv);print(json.dumps(r,sort_keys=True,separators=(",",":"),ensure_ascii=False));return c
