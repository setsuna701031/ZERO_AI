...
class RuntimeStateGuard:
    ...
    SECTION_OWNERS: Dict[str, Tuple[str, ...]] = {
        ...
        "review_resolved": ("task_runtime", "task_runner"),
        "review_approved": ("task_runtime", "task_runner"),
        "review_resolution": ("task_runtime", "task_runner"),
        "blocker_resolved": ("task_runtime", "task_runner"),
        "unblock_confirmed": ("task_runtime", "task_runner"),
        "replan_approved": ("task_runtime", "task_runner"),
