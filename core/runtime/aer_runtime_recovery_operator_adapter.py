"""Passive Operator-facing Runtime Recovery adapter reports."""
...
RECOVERY_OPERATOR_ADAPTER_REPORT_CONTRACT = "aer.runtime.recovery.operator_adapter_report.v1"
RECOVERY_OPERATOR_ADAPTER_ALLOWED_STATUSES = ("prepared", "blocked", "denied")
...
def prepare_recovery_operator_adapter_report(
    ...
    *,
    ...
    """Prepare deterministic Operator-facing adapter data without runtime effects."""
    ...
    return {
        "contract": RECOVERY_OPERATOR_ADAPTER_REPORT_CONTRACT,
        "adapter_id": adapter_id,
        "adapter_target": "operator",
        "prepared": prepared,
        "blocked": blocked,
        "denied": denied,
        "status": status,
        ...
        "denied_capabilities": list(RECOVERY_OPERATOR_ADAPTER_DENIED_CAPABILITIES),
