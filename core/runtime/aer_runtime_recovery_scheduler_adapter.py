"""Passive Scheduler-facing Runtime Recovery adapter reports."""
...
RECOVERY_SCHEDULER_ADAPTER_REPORT_CONTRACT = "aer.runtime.recovery.scheduler_adapter_report.v1"
RECOVERY_SCHEDULER_ADAPTER_ALLOWED_STATUSES = ("prepared", "blocked", "denied")
...
def prepare_recovery_scheduler_adapter_report(
    ...
    *,
    ...
    """Prepare deterministic Scheduler-facing adapter data without runtime effects."""
    ...
    return {
        "contract": RECOVERY_SCHEDULER_ADAPTER_REPORT_CONTRACT,
        "adapter_id": adapter_id,
        "adapter_target": "scheduler",
        "prepared": prepared,
        "blocked": blocked,
        "denied": denied,
        "status": status,
        ...
        "denied_capabilities": list(RECOVERY_SCHEDULER_ADAPTER_DENIED_CAPABILITIES),
