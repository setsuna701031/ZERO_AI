"""Passive Native Runtime-facing Runtime Recovery adapter reports."""
...
RECOVERY_NATIVE_ADAPTER_REPORT_CONTRACT = "aer.runtime.recovery.native_adapter_report.v1"
RECOVERY_NATIVE_ADAPTER_ALLOWED_STATUSES = ("prepared", "blocked", "denied")
...
def prepare_recovery_native_adapter_report(
    ...
    *,
    ...
    """Prepare deterministic Native Runtime-facing adapter data without runtime effects."""
    ...
    return {
        "contract": RECOVERY_NATIVE_ADAPTER_REPORT_CONTRACT,
        "adapter_id": adapter_id,
        "adapter_target": "native_runtime",
        "prepared": prepared,
        "blocked": blocked,
        "denied": denied,
        "status": status,
        ...
        "denied_capabilities": list(RECOVERY_NATIVE_ADAPTER_DENIED_CAPABILITIES),
