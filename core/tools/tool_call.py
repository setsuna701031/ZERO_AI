...
def tool_call_trace_event(tool_result: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "risk_level": str(controller.get("risk_level") or ""),
        "risk_reason": str(controller.get("risk_reason") or ""),
        "confirmation_required": bool(controller.get("confirmation_required")),
