...
SCHEMA='zero.engineering.runtime_adapter_execution_integration_closure.v1'; ID_KEY='execution_integration_closure_id'; PREFIX='ecl-'; STATUS_KEY='closure_status'; STATUSES={'not_closed', 'invalid', 'closed'}
...
def build_runtime_adapter_execution_integration_closure(*args, **kwargs):
 data=dict(kwargs)
...
def validate_runtime_adapter_execution_integration_closure(v):
...
def inspect_runtime_adapter_execution_integration_closure(v):
 r=validate_runtime_adapter_execution_integration_closure(v); return inspect_result(r.valid,r.errors)
