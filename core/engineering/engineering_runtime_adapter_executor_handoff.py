...
SCHEMA='zero.engineering.runtime_adapter_executor_handoff.v1'; ID_KEY='executor_handoff_id'; PREFIX='xhd-'; STATUS_KEY='handoff_status'; STATUSES={'handed_off', 'invalid'}
...
def build_runtime_adapter_executor_handoff(*args, **kwargs):
 data=dict(kwargs)
...
def validate_runtime_adapter_executor_handoff(v):
...
def inspect_runtime_adapter_executor_handoff(v):
 r=validate_runtime_adapter_executor_handoff(v); return inspect_result(r.valid,r.errors)
