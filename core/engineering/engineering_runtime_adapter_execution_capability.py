...
SCHEMA='zero.engineering.runtime_adapter_execution_capability.v1'; ID_KEY='capability_id'; PREFIX='ecp-'; STATUS_KEY='capability_status'; STATUSES={'invalid', 'declared'}
...
def build_runtime_adapter_execution_capability(*args, **kwargs):
 data=dict(kwargs)
...
def validate_runtime_adapter_execution_capability(v):
...
def inspect_runtime_adapter_execution_capability(v):
 r=validate_runtime_adapter_execution_capability(v); return inspect_result(r.valid,r.errors)
