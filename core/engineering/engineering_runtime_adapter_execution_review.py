...
SCHEMA='zero.engineering.runtime_adapter_execution_review.v1'; ID_KEY='execution_review_id'; PREFIX='erv-'; STATUS_KEY='review_status'; STATUSES={'invalid', 'approved', 'rejected'}
...
def build_runtime_adapter_execution_review(*args, **kwargs):
 data=dict(kwargs)
...
def validate_runtime_adapter_execution_review(v):
...
def inspect_runtime_adapter_execution_review(v):
 r=validate_runtime_adapter_execution_review(v); return inspect_result(r.valid,r.errors)
