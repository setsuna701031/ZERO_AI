...
SCHEMA='zero.engineering.runtime_adapter_execution_environment_admission.v1'; ID_KEY='environment_admission_id'; PREFIX='eea-'; STATUS_KEY='admission_status'; STATUSES={'not_admitted', 'invalid', 'admitted'}
...
def build_runtime_adapter_execution_environment_admission(*args, **kwargs):
 data=dict(kwargs)
...
def validate_runtime_adapter_execution_environment_admission(v):
...
def inspect_runtime_adapter_execution_environment_admission(v):
 r=validate_runtime_adapter_execution_environment_admission(v); return inspect_result(r.valid,r.errors)
