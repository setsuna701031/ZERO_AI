...
SCHEMA='zero.engineering.runtime_adapter_execution_isolation_policy.v1'; ID_KEY='isolation_policy_id'; PREFIX='eip-'; STATUS_KEY='isolation_status'; STATUSES={'valid', 'invalid'}
...
def build_runtime_adapter_execution_isolation_policy(*args, **kwargs):
 data=dict(kwargs)
...
def validate_runtime_adapter_execution_isolation_policy(v):
...
def inspect_runtime_adapter_execution_isolation_policy(v):
 r=validate_runtime_adapter_execution_isolation_policy(v); return inspect_result(r.valid,r.errors)
