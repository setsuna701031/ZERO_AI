...
SCHEMA='zero.engineering.runtime_adapter_execution_envelope.v1'; ID_KEY='execution_envelope_id'; PREFIX='env-'; STATUS_KEY='envelope_status'; STATUSES={'invalid', 'sealed'}
...
def build_runtime_adapter_execution_envelope(*args, **kwargs):
 data=dict(kwargs)
...
def validate_runtime_adapter_execution_envelope(v):
...
def inspect_runtime_adapter_execution_envelope(v):
 r=validate_runtime_adapter_execution_envelope(v); return inspect_result(r.valid,r.errors)
