...
SCHEMA='zero.engineering.runtime_adapter_execution_preparation.v1'; ID_KEY='execution_preparation_id'; PREFIX='epr-'; STATUS_KEY='preparation_status'; STATUSES={'prepared', 'invalid'}
...
def build_runtime_adapter_execution_preparation(*args, **kwargs):
 data=dict(kwargs)
...
def validate_runtime_adapter_execution_preparation(v):
...
def inspect_runtime_adapter_execution_preparation(v):
 r=validate_runtime_adapter_execution_preparation(v); return inspect_result(r.valid,r.errors)
