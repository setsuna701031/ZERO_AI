...
SCHEMA='zero.engineering.runtime_adapter_binding_resolution.v1'; ID_KEY='binding_resolution_id'; PREFIX='ebr-'; STATUS_KEY='binding_status'; STATUSES={'invalid', 'resolved'}
...
def build_runtime_adapter_binding_resolution(*args, **kwargs):
 data=dict(kwargs)
...
def validate_runtime_adapter_binding_resolution(v):
...
def inspect_runtime_adapter_binding_resolution(v):
 r=validate_runtime_adapter_binding_resolution(v); return inspect_result(r.valid,r.errors)
