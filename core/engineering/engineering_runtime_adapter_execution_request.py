...
SCHEMA='zero.engineering.runtime_adapter_execution_request.v1'; ID_KEY='execution_request_id'; PREFIX='erq-'; STATUS_KEY='request_status'; STATUSES={'accepted', 'invalid'}
...
def build_runtime_adapter_execution_request(*args, **kwargs):
 data=dict(kwargs)
...
def validate_runtime_adapter_execution_request(v):
...
def inspect_runtime_adapter_execution_request(v):
 r=validate_runtime_adapter_execution_request(v); return inspect_result(r.valid,r.errors)
