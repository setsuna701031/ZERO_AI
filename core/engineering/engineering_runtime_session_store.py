...
ALLOWED_FILES=ALLOWED_FILES+("reproduction/workspace-snapshot.json","repair/planning-intake.json","repair/root-cause-hypothesis.json","repair/impact-analysis.json","repair/strategy-candidate.json","repair/patch-candidate.json","repair/patch-validation.json","repair/patch-review.json","patch-authoring/intake.json","patch-authoring/source-snapshots.json","patch-authoring/file-edits.json","patch-authoring/test-edits.json","patch-authoring/candidate-diff.json","patch-authoring/validation.json","patch-authoring/review.json","change-package/preparation-intake.json","change-package/candidate.json","change-package/validation.json","change-package/approval.json","authorization/request.json","authorization/decision.json","authorization/authorized-package.json","authorization/readiness.json","apply/request.json","apply/admission.json","apply/authorization-usage.json","apply/transaction.json","apply/operation-evidence.json","apply/result.json","apply/verification-result.json","apply/completion-candidate.json","apply/completion-review.json")
...
ALLOWED_FILES=ALLOWED_FILES+("push/preparation.json","push/remote-verification-before.json","push/review.json","push/authorization.json","push/execution.json","push/evidence.json","push/remote-verification-after.json","push/closure.json")
