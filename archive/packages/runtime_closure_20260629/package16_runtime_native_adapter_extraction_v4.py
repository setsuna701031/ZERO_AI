...
def _backup(path: Path) -> None:
    ...
    backup = path.with_name(f"{path.name}.package16v4_backup_{stamp}")
...
def main() -> int:
    ...
    report = "\n".join([
        "Package16 v4 Runtime Native Adapter Extraction Report",
        "",
        f"root: {ROOT}",
