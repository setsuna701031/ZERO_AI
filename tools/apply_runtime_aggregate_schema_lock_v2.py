...
TEST_PATH = Path("tests/test_runtime_aggregate_schema_lock_v2.py")
...
def main() -> None:
    ...
    print("[runtime-aggregate-schema-lock-v2] created tests/test_runtime_aggregate_schema_lock_v2.py")
